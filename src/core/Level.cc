...
void Level::GenLevel(const Texture &texture, const ShaderProgram &program) {
  for (int i = 0; i < 32; i++) {
...
void Level::Draw(const Texture &texture, const glm::mat4 &Projection, const glm::mat4 &View) {
